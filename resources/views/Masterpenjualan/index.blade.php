                        ...
                        <div class="table-responsive">
                            <table class="table table-striped text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">{{ ($tpenjualan->currentPage() - 1) * $tpenjualan->perPage() + $item + 1 }}</th>
                            ...
                            <div>
                                <div class="d-flex justify-content-between">
                                    <div>
                                        Showing {{ $tpenjualan->firstItem() }} to {{ $tpenjualan->lastItem() }} of {{ $tpenjualan->total() }} entries
                                    </div>
                                    <div class="d-flex justify-content-end">
                                        {{ $tpenjualan->appends(request()->query())->links('vendor.pagination.custom') }}
                                    </div>
                                </div>
                            </div>
                        </div>
