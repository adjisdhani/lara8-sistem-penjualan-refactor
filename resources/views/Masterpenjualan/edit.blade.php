                    ...
                    <div class="card">
                        ...
                        <div class="tab-content p-4" id="pills-tabContent-basic-forms">
                            <div class="tab-pane tab-example-design fade show active" id="pills-basic-forms-design"
                                ...
                                <form action="/master-penjualan/{{ $tpenjualan->id }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <!-- Input -->
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="selectOne" class="form-select" name="nama_barang_id">
                                            ...
                                            @if ($bp->id === $tpenjualan->nama_barang_id )
                                            <option value="{{ $bp->id }}" selected>{{ $bp->nama_barang }}</option>
                                            @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="jumlah_terjual" class="form-control"
                                            ...
                                            value="{{ $tpenjualan->jumlah_terjual }}">
                                    </div>
