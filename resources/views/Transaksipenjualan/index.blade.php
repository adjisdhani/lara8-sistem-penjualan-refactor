                ...
                <div class="d-flex justify-content-around mt-3 mb-3 ms-3 me-3">
                    <div class="col-6 ms-4">
                        <a href="{{ route('transaksi-penjualan.reset') }}"
                            class="m-2 btn btn-outline-danger my-1 btn-sm" style="display: {{ $aksesMenu['delete'] == true ? : 'none' }}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">{{ ($wtransaksi->currentPage() - 1) * $wtransaksi->perPage() + $item + 1 }}</th>
                            ...
                            <div>
                                <div class="d-flex justify-content-between">
                                    <div>
                                        Showing {{ $wtransaksi->firstItem() }} to {{ $wtransaksi->lastItem() }} of {{ $wtransaksi->total() }} entries
                                    </div>
                                    <div class="d-flex justify-content-end">
                                        {{ $wtransaksi->appends(request()->query())->links('vendor.pagination.custom') }}
                                    </div>
                                </div>
                            </div>
                        </div>
